...
/* ═══════════════════════════════════════════════════════════
   ...
   Agora o proprio editor avisa aqui depois de salvar, e as paginas
...
export async function POST(request: Request) {
  // Sem sessao valida, ninguem invalida nada: um endpoint aberto
  // deixaria qualquer um forcar rebuild das paginas o dia inteiro.
